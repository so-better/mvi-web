<template>
    <m-overlay :show="show" @show="overlayShow" @hide="overlayHide" :use-padding="usePadding" :z-index="zIndex" @click.self="hide" :color="overlayColor" :timeout="timeout" :local="local">
            ...
            if (this.fullScreen) {
                if (this.local) {
                    this.$refs.modal.style.width =
                        this.$el.offsetParent.offsetWidth + 'px'
                    this.$refs.wrapper.style.height =
                        this.$el.offsetParent.offsetHeight + 'px'
                } else {
                ...
                if (this.local) {
                    this.$refs.wrapper.style.maxHeight =
                        this.$el.offsetParent.offsetHeight * 0.96 + 'px'
                } else {
                    this.$refs.wrapper.style.maxHeight =
                        window.innerHeight * 0.96 + 'px'
                }
                this.$refs.wrapper.style.height = ''
            }
        },
