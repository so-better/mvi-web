                        ...
                        <m-tab :title="menu[0].label">
                            <div v-if="menu[0].value == 'link'" class="mvi-editor-link">
                                ...
                                <div class="mvi-editor-link-footer">
                                    <m-checkbox label="新窗口打开" label-placement="right" icon-size="0.24rem" label-size="0.24rem" label-color="#808080" :fill-color="editor.activeColor" :checked.sync="linkTarget"></m-checkbox>
