<template>
    <div :class="fieldClass" :disabled="disabled" :data-type="type">
        ...
        <div :class="fieldBodyClass" :style="fieldBodyStyle">
            ...
            <textarea ref="textarea" v-if="type=='textarea'" :disabled="disabled" :readonly="readonly" class="mvi-field-input" :style="inputStyle" :placeholder="placeholder" v-model="realValue" v-on="listeners" autocomplete="off" @focus="inputFocus" @blur="inputBlur" :maxlength="maxlength" :name="name" :autofocus="autofocus" :rows="rowsFilter"></textarea>
            <input v-else ref="input" :disabled="disabled" :readonly="readonly" class="mvi-field-input" :style="inputStyle" :type="computedType" :placeholder="placeholder" v-model="realValue" v-on="listeners" autocomplete="off" :inputmode="computedInputMode" @focus="inputFocus" @blur="inputBlur" :name="name" :autofocus="autofocus" :maxlength="maxlength">
