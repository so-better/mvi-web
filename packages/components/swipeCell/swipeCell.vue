<template>
    <div class="mvi-swipe-cell" v-on="listeners" @touchstart="cellTouchStart" @touchmove="cellTouchMove" @touchend="cellTouchEnd" :style="cellStyle" :disabled="disabled" @mousedown="cellMouseDown">
...
export default {
    ...
    mounted() {
        $dap.event.on(
            document.body,
            `mousemove.swipeCell_${this._uid}`,
            this.cellMouseMove
        )
        $dap.event.on(
            document.body,
            `mouseup.swipeCell_${this._uid}`,
            this.cellMouseUp
        )
    },
    methods: {
    ...
    beforeDestroy() {
        $dap.event.off(
            document.body,
            `mousemove.swipeCell_${this._uid} mouseup.swipeCell_${this._uid}`
        )
    }
}
</script>
