...
export default {
    ...
    mounted() {
        ...
        if (this.fade) {
            ...
            $dap.event.on(
                document.body,
                `mousemove.swiper_${this._uid}`,
                this.swiperMouseMove
            )
            $dap.event.on(
                document.body,
                `mouseup.swiper_${this._uid}`,
                this.swiperMouseUp
            )
        }
    ...
    beforeDestroy() {
        ...
        if (!this.fade) {
            $dap.event.off(
                document.body,
                `mousemove.swiper_${this._uid} mouseup.swiper_${this._uid}`
            )
        }
...
.mvi-swiper-indicators.mvi-swiper-indicators-vertical
    > .mvi-swiper-indicator.mvi-swiper-indicator:last-child {
    margin-bottom: 0;
}
