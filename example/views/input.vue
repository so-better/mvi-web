<template>
	<div>
		<m-input left-icon="user" right-icon="check" border v-model="value" placeholder="请输入内容..." label="内容"></m-input>
		<m-input class="mvi-mt-2" disabled v-model="value" placeholder="请输入内容..." label="内容"></m-input>
